          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <div className="relative group">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 group-hover:text-blue-600 transition-colors" />
                <motion.input
                  type="text"
                  name="name"
                  value={formData.name}
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative group">
                <CreditCard className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 group-hover:text-blue-600 transition-colors" />
                <motion.input
                  type="text"
                  name="nationalId"
              ...
              <div className="flex gap-2">
                <div className="relative w-32">
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-3 pr-8 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-600 focus:ring-2 focus:ring-blue-100 outline-none transition-all appearance-none bg-white cursor-pointer hover:border-gray-300"
                  >
                ...
                <div className="relative flex-1 group">
                  <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 group-hover:text-blue-600 transition-colors" />
                  <motion.input
                    type="tel"
                    name="phone"
